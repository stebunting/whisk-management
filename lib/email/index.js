...
function email() {
  ...
  async function sendBoxLoanReminder(user) {
    ...
    emailConfig.text = `Hello ${user.forename},\n\nJust a reminder that your box is due back on ${dateFormat(user.dateIn, { format: 'long' })}.\n\nIf it's not returned in the next two days you will be charged 750kr.\n\nAs we aren’t always in the shop, you can always leave your box (and accessories) in the main building reception under WHISK's mail box. It’s the door to the left of WHISK and the door code is 5367. Please can you send us a message when you have dropped the box off.\n\nTeam WHISK`;
    try {
